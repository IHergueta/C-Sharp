...
namespace Practica2 {
    ...
    public partial class miagendaDataSet : global::System.Data.DataSet {
        ...
        public partial class agendaDataTable : global::System.Data.TypedTableBase<agendaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public agendaRow AddagendaRow(string nombre, int year) {
        ...
        public partial class tareaDataTable : global::System.Data.TypedTableBase<tareaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tareaRow AddtareaRow(agendaRow parentagendaRowBytarea_ibfk_1, int dia, int mes, int hora, string descripcion, string lugar) {
            ...
            private void InitClass() {
                ...
                this.columnlugar.MaxLength = 120;
            }
        ...
        public partial class agendaRow : global::System.Data.DataRow {
            ...
            public int year {
                get {
                    return ((int)(this[this.tableagenda.yearColumn]));
                }
                set {
                    this[this.tableagenda.yearColumn] = value;
                }
            }
...
namespace Practica2.miagendaDataSetTableAdapters {
    ...
    public partial class agendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `agenda` WHERE ((`id` = @p1) AND (`nombre` = @p2) AND (`year` = @p3))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `agenda` (`nombre`, `year`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `agenda` SET `nombre` = @p1, `year` = @p2 WHERE ((`id` = @p3) AND (`nombre" +
                "` = @p4) AND (`year` = @p5))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `nombre`, `year` FROM `agenda`";
    ...
    public partial class tareaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT tarea.id_agenda, tarea.dia, tarea.mes, tarea.hora, tarea.descripcion, tare" +
                "a.lugar\r\nFROM   tarea INNER JOIN\r\n             agenda ON agenda.id = tarea.id_ag" +
                "enda\r\nWHERE (agenda.id = @id)";
            ...
            this._commandCollection[2].CommandText = "SELECT tarea.id_agenda, tarea.dia, tarea.mes, tarea.hora, tarea.descripcion, tare" +
                "a.lugar\r\nFROM   tarea INNER JOIN\r\n             agenda ON agenda.id = tarea.id_ag" +
                "enda\r\nWHERE (agenda.id = @id) AND (tarea.dia = @dia)";
        ...
        public virtual int FillBy(miagendaDataSet.tareaDataTable dataTable, int id) {
        ...
        public virtual miagendaDataSet.tareaDataTable GetDataBy(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            miagendaDataSet.tareaDataTable dataTable = new miagendaDataSet.tareaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(miagendaDataSet.tareaDataTable dataTable, int id, int dia) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            this.Adapter.SelectCommand.Parameters[1].Value = ((int)(dia));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual miagendaDataSet.tareaDataTable GetDataBy1(int id, int dia) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            this.Adapter.SelectCommand.Parameters[1].Value = ((int)(dia));
            miagendaDataSet.tareaDataTable dataTable = new miagendaDataSet.tareaDataTable();
